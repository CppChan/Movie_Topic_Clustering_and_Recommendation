...
def _get_training_data2(tf_records_train_path,batch_size):
    ''' Buildind the input pipeline for training and inference using TFRecords files.
    @return data only for the training
    @return data for the inference
    '''

    filenames = [tf_records_train_path + f for f in os.listdir(tf_records_train_path)]
...
def _get_test_data2(tf_records_test_path):
    ''' Buildind the input pipeline for test data.'''

    filenames = [tf_records_test_path + f for f in os.listdir(tf_records_test_path)]
